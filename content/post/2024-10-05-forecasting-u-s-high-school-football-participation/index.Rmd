...
After fitting the model to the data, and then applying to the test set, the model is applied the entire dataset and forecasts the number of players per 100 students for the next five years.  The forecast predicts a slight rebound in participation rates.  The forecasted number of players per 100 students is shown below.  ARIMA modeling it not recommended on small datasets like this one with 30 being the minimum. However, 30 is general advice and deviation may be appropriate depending on the number of parameters and the amount of noise within the data.[@hyndman_forecasting_2021]
...
High school football participation rates have been in decline since 2005.  The bump up in the data from the 2022 data point had a big influence in the ARIMA-based forecast.  The forecast shows participation rates recovering with a wide range of possible outcomes in the 80th and 95th confidence intervals. The forecast is predicting a slight rebound in participation rates. Some caveats in about the forecast include the following: (1) it is based on 20 observations, (2) outliers were removed, and (3) missing data was interpolated COVID-19 period.  The forecast is provided for discussion purposes only.
