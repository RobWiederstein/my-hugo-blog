...
- a **homogenous** vector is one where all elements of the vector are the same type.

- a **heterogenous** vector is one where the elements are of different types and by definition must be a list. 
...
2. Importing data in chunks is often easier when appending to a list rather 
than a dataframe.

3. .json and .xml are scraped as lists.

# [Create a list](#list-creation)
...
This post discussed what a list is and how it is described.   You should be able to create a list, subset and extract lists, append to a list and convert a list to an array.
