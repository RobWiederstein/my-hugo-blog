...
Flexdashboard creates slick dashboards for the presentation of data.  However, it didn't have a footer.  Below is a footer that worked for a dashboard that I created.  
