...
It's been a while since I'd done any modeling so, quite on accident, I'd discovered that Rstudio has released a new package `tinymodels`.  Prior to stumbling into the new package, the `caret` package, by Max Kuhn,  was the default for any modeling by Max Kuhn.  So it was a great comfort to learn that  he released an updated, vegetable-themed package `parsnip`. 
...
They've been included as gist embeds and you can simply copy and paste the text into your script. Make sure to hit the outline button in Rstudio so you can see the outline headings.
