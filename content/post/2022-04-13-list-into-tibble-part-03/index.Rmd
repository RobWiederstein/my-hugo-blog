...
More rigorous examples of lists to tibbles are reserved for [Rectangling - Part 04](https://robwiederstein.org) and [Use Cases - Part 05](https://robwiederstein.org).  The concept of a "list-column" figures prominently in the discussion.  It is a powerful method for storing one or more lists within a single tibble.
...
`enframe()` converts named atoic vecotrs or lists to one or two column dataframes.  It's opposite is `deframe()`.
